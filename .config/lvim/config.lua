...
lvim.keys.normal_mode["<C-p>"] = ":Telescope find_files find_command=rg,--ignore,--files<cr>"
lvim.keys.normal_mode["<leader>1"] = "1gt"
lvim.keys.normal_mode["<leader>2"] = "2gt"
lvim.keys.normal_mode["<leader>3"] = "3gt"
...
lvim.builtin.treesitter.auto_intall = true
